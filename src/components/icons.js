export function HeartIcon({ className = "", ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 21s-7.5-4.6-10.05-9.18C.3 8.7 1.7 5.2 5.05 4.6c2-.36 3.86.6 4.95 2.2 1.09-1.6 2.95-2.56 4.95-2.2 3.35.6 4.75 4.1 3.1 7.22C19.5 16.4 12 21 12 21z" />
    </svg>
  );
}
